...
export const metadata: Metadata = {
  ...
  alternatives: {
    canonical: 'https://itsrkmahapatra.github.io/Docuvate/pdf/add-page-numbers/',
  },
  openGraph: {
    title: 'Add Page Numbers to PDF Free - 100% Private Alternative to iLovePDF',
    description: 'Insert customized page numbers (header/footer, left/center/right) into PDF documents. Docuvate operates 100% client-side. Your files never touch any server. Free alternative to iLovePDF and Pi7 PDF.',
    url: 'https://itsrkmahapatra.github.io/Docuvate/pdf/add-page-numbers/',
    siteName: 'Docuvate',
    images: [
      {
        ...
        width: 800,
        height: 600,
        alt: 'Add Page Numbers to PDF Free - 100% Private Alternative to iLovePDF',
      },
    ],
    locale: 'en_US',
    type: 'website',
