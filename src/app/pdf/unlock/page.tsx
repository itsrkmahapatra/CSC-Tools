...
export const metadata: Metadata = {
  ...
  alternatives: {
    canonical: 'https://itsrkmahapatra.github.io/Docuvate/pdf/unlock/',
  },
  openGraph: {
    title: 'Unlock PDF Free - 100% Private Alternative to iLovePDF & Pi7',
    description: 'Remove password restrictions and decrypt protected PDF documents. Docuvate operates 100% client-side. Your files never touch any server. Free alternative to iLovePDF and Pi7 PDF.',
    url: 'https://itsrkmahapatra.github.io/Docuvate/pdf/unlock/',
    siteName: 'Docuvate',
    images: [
      {
        ...
        width: 800,
        height: 600,
        alt: 'Unlock PDF Free - 100% Private Alternative to iLovePDF & Pi7',
      },
    ],
    locale: 'en_US',
    type: 'website',
