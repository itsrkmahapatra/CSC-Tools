...
export const metadata: Metadata = {
  ...
  alternatives: {
    canonical: 'https://itsrkmahapatra.github.io/Docuvate/convert/jpg-to-pdf/',
  },
  openGraph: {
    title: 'JPG to PDF Converter Free - 100% Private Alternative to iLovePDF & Pi7',
    description: 'Convert JPEG, PNG, WebP, SVG, BMP, and GIF images to PDF documents. Docuvate operates 100% client-side. Your files never touch any server. Free alternative to iLovePDF and Pi7 PDF.',
    url: 'https://itsrkmahapatra.github.io/Docuvate/convert/jpg-to-pdf/',
    siteName: 'Docuvate',
    images: [
      {
        ...
        width: 800,
        height: 600,
        alt: 'JPG to PDF Converter Free - 100% Private Alternative to iLovePDF & Pi7',
      },
    ],
    locale: 'en_US',
    type: 'website',
