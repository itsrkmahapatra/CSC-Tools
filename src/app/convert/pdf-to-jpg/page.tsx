...
export const metadata: Metadata = {
  ...
  alternatives: {
    canonical: 'https://itsrkmahapatra.github.io/Docuvate/convert/pdf-to-jpg/',
  },
  openGraph: {
    title: 'PDF to JPG Converter Free - 100% Private Alternative to iLovePDF & Pi7',
    description: 'Convert PDF pages to JPEG, PNG, or WebP images and download as a ZIP archive. Docuvate operates 100% client-side. Your files never touch any server. Free alternative to iLovePDF and Pi7 PDF.',
    url: 'https://itsrkmahapatra.github.io/Docuvate/convert/pdf-to-jpg/',
    siteName: 'Docuvate',
    images: [
      {
        ...
        width: 800,
        height: 600,
        alt: 'PDF to JPG Converter Free - 100% Private Alternative to iLovePDF & Pi7',
      },
    ],
    locale: 'en_US',
    type: 'website',
